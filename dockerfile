...
ENV APP_USER=axway
RUN wget https://github.com/Axway-API-Management-Plus/apim-cli/releases/download/1.14.4/axway-apimcli-1.14.4.tar.gz
ARG APIM_CLI_ARCHIVE
ENV APIM_CLI_ARCHIVE=${APIM_CLI_ARCHIVE:-axway-apimcli-1.14.4.tar.gz}
